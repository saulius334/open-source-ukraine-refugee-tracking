        ...
        <div class="col-5">
            <div class="card">
                <div class="card-header">
                    <h2>Request A Registration</h2>
                </div>
                <div class="card-body">
                    <form action="{{route('req_store')}}" method="post" enctype="multipart/form-data" class="--form">
                        ...
                        @csrf
                        <button type="submit" class="btn btn-secondary mt-4 --submit">Request</button>
                    </form>
                </div>
            </div>
        </div>
